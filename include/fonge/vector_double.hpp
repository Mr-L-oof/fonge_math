...
struct double2 {
    ...
    inline bool operator==(double2 rhs) {
        return double2(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_EQ)).all();
    }

    inline bool operator!=(double2 rhs) {
        return double2(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_NE)).all();
    }

    inline bool operator<(double2 rhs) {
        return double2(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_LT)).all();
    }

    inline bool operator<=(double2 rhs) {
        return double2(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_LE)).all();
    }

    inline bool operator>=(double2 rhs) {
        return double2(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_NLT)).all();
    }

    inline bool operator>(double2 rhs) {
        return double2(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_NLE)).all();
    }
...
struct double3 {
    ...
    inline bool operator==(double3 rhs) {
        return double3(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_EQ)).all();
    }

    inline bool operator!=(double3 rhs) {
        return double3(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_NE)).all();
    }

    inline bool operator<(double3 rhs) {
        return double3(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_LT)).all();
    }

    inline bool operator<=(double3 rhs) {
        return double3(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_LE)).all();
    }

    inline bool operator>=(double3 rhs) {
        return double3(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_NLT)).all();
    }

    inline bool operator>(double3 rhs) {
        return double3(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_NLE)).all();
    }
...
struct double4 {
    ...
    inline bool operator==(double4 rhs) {
        return double4(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_EQ)).all();
    }

    inline bool operator!=(double4 rhs) {
        return double4(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_NE)).all();
    }

    inline bool operator<(double4 rhs) {
        return double4(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_LT)).all();
    }

    inline bool operator<=(double4 rhs) {
        return double4(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_LE)).all();
    }

    inline bool operator>=(double4 rhs) {
        return double4(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_NLT)).all();
    }

    inline bool operator>(double4 rhs) {
        return double4(simde_mm256_cmp_pd(simd, rhs.simd, SIMDE_MM_CMPINT_NLE)).all();
    }
    ...
    inline double4 cross(double4 mhs, double4 rhs) {
        return (yxxx()*(mhs.zzyy()*rhs.wwwz() - rhs.zzyy()*mhs.wwwz()) -
                ...
                wwwz()*(mhs.yxxx()*rhs.zzyy() - rhs.yxxx()*mhs.zzyy())) * double4(1, -1, 1, -1);
