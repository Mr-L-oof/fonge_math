...
struct double2x2 {
  inline double2x2() : cols{double2(1, 0), double2(0, 1)} {}

  inline double2x2(double m11, double m21, double m12, double m22)
      : cols{double2(m11, m12), double2(m21, m22)} {}

  inline double2x2(double2 col1, double2 col2) : cols{col1, col2} {}
  ...
  inline double trace() { return col1.x() + col2.y(); }

  inline double determinant() { return col1.dot(col2.cross()); }

  inline double2x2 cofactor() { return double2x2(col2.cross(), -col1.cross()); }

  inline double2x2 inverse() {
    return (cofactor().transposed()) * (1 / determinant());
  }

  static inline double2x2 identity() { return double2x2(); }
...
struct double3x3 {
  ...
  inline double3x3(double m11, double m21, double m31, double m12, double m22,
                   double m32, double m13, double m23, double m33)
  ...
  inline double3x3 operator*(double3x3 rhs) {
    return double3x3((*this) * rhs.col1, (*this) * rhs.col2,
                     (*this) * rhs.col3);
  }
  ...
  inline double3x3 transposed() {
    ...
    return double3x3(double3(tmp1.xy(), col3.x()), double3(tmp1.zw(), col3.y()),
                     double3(tmp2, col3.z()));
  }

  inline double trace() { return col1.x() + col2.y() + col3.z(); }

  inline double determinant() { return col1.dot(col2.cross(col3)); }
  ...
  inline double3x3 inverse() { return cofactor().transposed() / determinant(); }

  static inline double3x3 identity() { return double3x3(); }
...
struct double4x4 {
  ...
  inline double4x4()
      : cols{double4(1, 0, 0, 0), double4(0, 1, 0, 0), double4(0, 0, 1, 0),
             double4(0, 0, 0, 1)} {}

  inline double4x4(double m11, double m21, double m31, double m41, double m12,
                   double m22, double m32, double m42, double m13, double m23,
                   double m33, double m43, double m14, double m24, double m34,
                   double m44)
  ...
  inline double4x4 operator+(double4x4 rhs) {
    return double4x4(col1 + rhs.col1, col2 + rhs.col2, col3 + rhs.col3,
                     col4 + rhs.col4);
  }
  ...
  inline double4x4 operator*(double4x4 rhs) {
    return double4x4((*this) * rhs.col1, (*this) * rhs.col2, (*this) * rhs.col3,
                     (*this) * rhs.col4);
  }
  ...
  inline double trace() { return col1.x() + col2.y() + col3.z() + col4.w(); }

  inline double determinant() { return col1.dot(col2.cross(col3, col4)); }

  inline double4x4 cofactor() {
    return double4x4(col2.cross(col3, col4), col1.cross(col3, col2),
  ...
  inline double4x4 inverse() { return cofactor().transposed() / determinant(); }

  static inline double4x4 identity() { return double4x4(); }
...
inline double4x4 operator*(double4x4 lhs, double rhs) {
  return double4x4(lhs.col1 * rhs, lhs.col2 * rhs, lhs.col3 * rhs,
                   lhs.col4 * rhs);
}
