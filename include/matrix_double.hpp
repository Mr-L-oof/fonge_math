...
struct double2x2 {
    ...
    inline double2x2(double4 numberVector) 
    : double2x2(numberVector.xy(), numberVector.wz()) {}
...
struct double4x4 {
    inline constexpr double4x4(const double4x4 &m) 
    : cols(m.cols) {};

    inline constexpr double4x4()
